## multimodal
logfile=gemma3-multimodal-lazy-eager-g2-20250910-after-pixel-value-fix.log;
...
## clm
logfile=gemma3-4b-clm-lazy-g2-20250909.log;
...
## text gen
logfile=gemma3-4b-text-lazy-eager-g2-20250910-after-pixel-value-fix.log;
...
if false; then
	PT_HPU_LAZY_MODE=1 python examples/text-generation/run_generation.py --model_name_or_path google/gemma-2-2b --use_hpu_graphs --use_kv_cache --max_new_tokens 100 --do_sample --prompt "DeepSpeed is a machine learning framework" --sdp_on_bf16
fi
## ci
logfile=gemma3-ci-lazy-g2-20250910-with-swa-pixvalue-fixes.log;
if false; then
...
PT_HPU_LAZY_MODE=1 python examples/text-generation/run_lm_eval.py --model_name_or_path google/gemma-3-4b-it  --use_hpu_graphs --use_kv_cache --bf16 --batch_size=1  --max_new_tokens 8192 --tasks piqa -o gemma-3-4b-it-eval-max_new_token_8192-g2-with-swa-pixvalue-fixes.json
PT_HPU_LAZY_MODE=1 python examples/text-generation/run_lm_eval.py --model_name_or_path google/gemma-3-4b-it  --use_hpu_graphs --use_kv_cache --bf16 --batch_size=1  --max_new_tokens 128 --tasks piqa -o gemma-3-4b-it-eval-max_new_token_128-g2-with-swa-pixvalue-fixes.json
PT_HPU_LAZY_MODE=1 python examples/text-generation/run_lm_eval.py --model_name_or_path google/gemma-3-27b-it  --use_hpu_graphs --use_kv_cache --bf16 --batch_size=1  --max_new_tokens 8192 --tasks piqa -o gemma-3-27b-it-eval-max_new_token_8192-g2-with-swa-pixvalue-fixes.json
PT_HPU_LAZY_MODE=1 python examples/text-generation/run_lm_eval.py --model_name_or_path google/gemma-3-27b-it  --use_hpu_graphs --use_kv_cache --bf16 --batch_size=1  --max_new_tokens 128 --tasks piqa -o gemma-3-27b-it-eval-max_new_token_128-g2-with-swa-pixvalue-fixes.json
